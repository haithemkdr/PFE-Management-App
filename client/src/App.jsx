...
import ResponsableMatierePanel from './pages/teacher/ResponsableMatierePanel';
...
import ParametrageModulesPage from './pages/agent/ParametrageModulesPage';
    ...
    <AuthProvider>
      <Routes>
        ...
        >
          ...
          <Route path="responsable" element={<ResponsableMatierePanel />} />
        ...
        >
          ...
          <Route path="parametrage"  element={<ParametrageModulesPage />} />
